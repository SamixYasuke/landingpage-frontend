...
export default function Header() {
  return (
    <Disclosure
      as="nav"
      className="bg-[#110D2E] w-full z-50 fixed top-0 line-clamp-3 kerning"
    >
      {({ open }) => (
        <>
          <div className="mx-auto container px-2 sm:px-4 lg:px-8 ">
            <div className="relative flex h-16 items-center justify-between ">
              <div className="">
                <img className="block h-10 w-auto" src={logoSvg} alt="img" />
              </div>
              ...
              <div className="lg:flex justify-center px-2 hidden ml-2 xl:ml-6 ">
                <div class="p-[1px] relative bg-[#110D2E] opacity-60 rounded-full max-w-sm bg-gradient-to-r from-[#FC466B] to-[#3F5EFB]">
                  <input
                    class="px-3 2xl:py-2 py-1 w-full text-[#3F5EFB] border-none  rounded-full bg-inherit z-50 focus:outline-none"
                    type="text"
                    id="name"
                  ...
                  <button
                    type="submit"
                    class="absolute right-0 top-0 2xl:mt-3 mt-2 mr-4 z-50"
                  >
            ...
            <div className="space-y-3 flex flex-col  mx-[15%]  pb-3 pt-2">
              <div class="p-[1px] relative  my-5 mt-10 ">
                <input
                  id="username"
                  type="text"
                  className=" w-full px-4 py-2 mt-4 text-blue-600 opacity-70   bg-transparent  formBorder-gradient  focus:outline-none focus:ring-0"
                  placeholder="enter your name"
                />
                <button
                  type="submit"
                  class="absolute right-0 top-0 mt-7 mr-4 z-50"
                >
                  <CiSearch className="h-5 w-5 fill-current text-white" />
                </button>
              </div>
              ...
              >
                <div className="flex gap-x-3">
                  <span>
                    {" "}
                    <AiFillPieChart className="" size={25} />
                  </span>
